...
$(document).ready(function() {
	...
	$(document).on('scroll', function() {
		$('.sec-solutions, .sec-functional__shop-inner, .sec-functional__corp-inner, .sec-functional__catalog-inner, .sec-assembly, .sec-step-1, .sec-step-2, .sec-step-3, .sec-step-4, .sec-result, .sec-ready, .sec-why-we').each(function() {
